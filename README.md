...
.active{display:flex}
.center{justify-content:center;align-items:center;flex-direction:column}
.bg{position:fixed;inset:0;background:linear-gradient(135deg,#0b1020,#1b1f3a,#432c52);z-index:-2}
.glow{position:fixed;width:400px;height:400px;border-radius:50%;filter:blur(120px);opacity:.35}
.g1{background:#ff5ea8;top:-100px;left:-100px}
.g2{background:#7c5cff;bottom:-100px;right:-100px}
...
<div class="memories-btn" onclick="toggleMemories()">📸 Album foto</div>
